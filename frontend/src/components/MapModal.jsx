                ...
                <div className="map-toolbar">
                    <div className="toolbar-left">
                        ...
                        <div className="toolbar-section">
                            ...
                            <select className="toolbar-select purpose-select" value={selectedPurpose} onChange={(e) => setSelectedPurpose(e.target.value)}>
                                {propertyPurposes.map(p => <option key={p} value={p}>{p}</option>)}
                            </select>
                        </div>
                    </div>
